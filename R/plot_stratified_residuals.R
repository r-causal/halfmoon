...
#' and revisited by McGowan, D'Agostino, and D'Agostino (2023).
...
#' @export
plot_stratified_residuals.lm <- function(x,
                                         treatment,
                                         ps_model = NULL,
...
#' @export
plot_stratified_residuals.data.frame <- function(x,
                                                  treatment,
                                                  residuals,
                                                  x_var,
                                                  plot_type = c("color", "facet", "both"),
...
plot_stratified_residuals_impl <- function(.residuals,
                                           .ps_or_fitted,
                                           .treatment,
                                           plot_type,
                                           smooth,
  ...
  # Check lengths
  validate_equal_length(.residuals, .ps_or_fitted, ".residuals", ".ps_or_fitted")

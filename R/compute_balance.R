...
#' not the distance covariance, that is 0 exactly when the weighted exposure and
#' covariates are independent. The `dimension_adj` argument controls the relative

...
#'
#' @format A data frame with 1566 rows and 18 variables: \describe{
...
#'   (baseline)} \item{wt82_71}{Weight change from 1971 to 1982} \item{death}{Death indicator}
#'   \item{w_ate}{ATE weight} \item{w_att}{ATT weight}
